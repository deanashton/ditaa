...
/**
 * This class is a custom Javadoc taglet for embedding ditaa diagrams in javadoc comments. The tag is an inline which can be used in any javadoc comment. The
 * tag can also be used in package documentation and in the overview. This taglet assumes that the Standard Javadoc Doclet is being used.
 * <p>
 * The syntax is:<br>
 * <code>
 ...
 * </code>
 * <p>
 * The diagram name will be used when generating the image, so that the image can be referenced to somewhere else (by using an a-href HTML tag). The diagram
 * name can only contain letters, numbers and underscore. The name of the generated image will become "&lt;classname&gt;-&lt;diagram name&gt;.png".
 * <p>
...
public class JavadocTaglet implements Taglet {
	 ...
	 * @param name
	 *                the diagram name that will be used for generating the output filename.
	 */
	...
	private String getRelativePath(File file) {
		...
		for (File element : srcPath) {
			String s = element.getAbsolutePath();
